...
def getTrainingData(window_name, camera_id, path_name, max_num): # path_name是图片存储目录，max_num是需要捕捉的图片数量
    ...
    classifier = cv2.CascadeClassifier('app/features/counter/haarcascade_frontalface_alt2.xml') # 加载分类器
...
if __name__ =='__main__':
    ...
    getTrainingData('getTrainData',0,'app/features/counter/image/image',20) # 注意这里的training_data_xx 文件夹就在程序工作目录下
